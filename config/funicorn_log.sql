...
CREATE TABLE `user_info` (
                             ...
                             `user_type` varchar(32) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'normal' COMMENT '用户类型 super/admin/normal',
                             `deleted` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '删除标识',
                             `created_by` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
                             `created_time` datetime DEFAULT NULL,
...
INSERT INTO `funicorn_log`.`user_info` (`id`, `nickname`, `username`, `password`, `user_type`, `deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES ('1', '超级管理员', 'admin', '$2a$10$S8YPF7oVC13iLYzokOqIYuHcfeU8T725U/B.rdaW0/YjdymWlIy8S', 'admin', '0', NULL, now(), NULL, NULL);
